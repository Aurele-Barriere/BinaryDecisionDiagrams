...
Ainsi, la construction du ROBDD se fait à partir de la formule obtenue. Il suffit alors d'éxécuter \code{anysat} pour obtenir une valuation qui satisfait le problème.
